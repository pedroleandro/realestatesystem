                    ...
                    <div class="nav_tabs_content">
                        <div id="data">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox"
                                           name="sale" {{ (old('sale') == 'on' || old('sale') == true ? 'checked' : ($property->sale == true ? 'checked' : '')) }}
                                    "><span>Venda</span>
                                </label>
                                ...
                                <label class="label">
                                    ...
                                    <select name="type" class="select2">
                                        <optgroup label="Imóvel Residencial">
                                            ...
                                            <option
                                                value="Cobertura" {{ (old('type') == 'roof' ? 'selected' : ($property->type == 'roof' ? 'selected' : '')) }}>
                                                Cobertura
                                            </option>
                                            <option
                            ...
                            <label class="label">
                                ...
                                <select name="user" class="select2">
                                    ...
                                    @foreach($users as $user)
                                        <option
                                            value="{{ $user->id }}" {{ ($user->id === $property->user ? 'selected' : '') }}>{{ $user->name }}
                                            ({{ $user->document }})
                                        </option>
                                    @endforeach
                                </select>
